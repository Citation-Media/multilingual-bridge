<?php
/**
 * DeepL Supported Target Languages Enum
 *
 * Type-safe enum for target languages supported by DeepL translation API
 *
 ...
 */
enum DeepL_Target_Language: string {
	case Arabic               = 'ar';
	case Bulgarian            = 'bg';
	case Czech                = 'cs';
	case Danish               = 'da';
	...
	case Portuguese_European  = 'pt-pt';
	case Romanian             = 'ro';
	case Russian              = 'ru';
	case Slovak               = 'sk';
	case Slovenian            = 'sl';
	...
	/**
	 * Get all target language codes as array
	 *
	 * @return array<string>
	 */
	...
	/**
	 * Check if a language code is supported as target
	 *
